...
Sub_Result_Dir=${Result_Dir}/TWAS/Perm
...
do
	...
	sub_twas_dir=${Sub_Result_Dir}/${ID}
	mkdir -p ${sub_twas_dir}

	# Input for OTTERS STAGE II
	# GWAS summary statistics 
	gwas_sst_file=${Simu_Dir}/Training/std_cp_${cp}_He2_${he2}/Null_${ID}_Set1_GWAS_Zscore_1.txt
	

	python3 ${OTTERS_DIR}/testing_perm.py \
...
# qsub -q b.q -cwd -j y -wd /home/qdai/YangFSSdata2/qdai/new_logs -N ReSimu_Perm -pe smp 1 -t 1-50 -tc 16 /home/qdai/YangFSSdata2/qdai/BS_TWAS/Scripts/4_revise_simu/3_run_OTTERS_StageII_Perm.sh
