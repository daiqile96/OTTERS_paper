...
eQTL_dir=/home/qdai8/projects/OTTERS/Data/RDA/Results/CHR${chr}/Batch${batch}
grex_dir=/home/qdai8/projects/OTTERS/Data/RDA/Results/CHR${chr}/Batch${batch}/GReX
sample_dir=/home/qdai8/projects/OTTERS/Data/RDA/sampleID.txt

python3 ${OTTERS_DIR}/imputing.py \
--OTTERS_dir=${OTTERS_DIR} \
--weight_dir=${eQTL_dir} \
--models=SDPR,PRScs,lassosum,P0.001,P0.05 \
--anno_dir=${exp_anno} \
--geno_dir=${geno_dir} \
--out_dir=${grex_dir} \
--chrom=${chr} \
...
twas_dir=/home/qdai8/projects/OTTERS/Data/RDA/Results/CHR${chr}/Batch${batch}/TWAS
